    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4" data-ga-category="Navbar">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <ul class="nav navbar-nav iconic">
                <li class="nav-item"><a class="nav-link" href="{{ url('/') }}" data-ga-label="Home"><i class="fa fa-home"></i></a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('about') }}" data-ga-label="About"><i class="fa fa-info-circle"></i></a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('contact') }}" data-ga-label="Contact"><i class="fa fa-envelope"></i></a></li>
            </ul>


            @canany(['manage-documents', 'view-examples', 'manage-assignments', 'administer-users', 'access-reports'])
            <ul class="nav navbar-nav mx-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        @can('administer-users')<a class="dropdown-item" href="{{ url('admin/users') }}">Manage users</a>@endcan
