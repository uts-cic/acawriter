        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-block p-5">
                    ...
                    <h4>Unsubscribe</h4>
                    <p class="card-text">
                        If you wish to withdraw from using AcaWriter, or if you wish to have your profile and data removed, please contact us using using the <a href="{{ url('contact') }}>contact form</a>.
                    </p>
